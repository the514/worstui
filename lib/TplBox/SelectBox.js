...
var _initialiseProps = function _initialiseProps() {
    ...
    _jquery2.default.each(_this3.state.selectLinkageOption, function (index, val) {
      ...
      if (value !== undefined) {
        selectTpl.push(_react2.default.createElement(
          _antd.Select,
          { key: index, value: value + "", onSelect: thisClass.handleLinkageSelect, placeholder: thisClass.props.placeholder[index] },
        ...
        if (thisClass.props.isFilter) {
          selectTpl.push(_react2.default.createElement(
            _antd.Select,
            { style: { marginRight: index === thisClass.state.selectLinkageOption.length - 1 ? 0 : 5 }, key: index, value: thisClass.state.selectLinkageValue[index] ? thisClass.state.selectLinkageValue[index] : "", onSelect: thisClass.handleLinkageSelect, placeholder: thisClass.props.placeholder[index] },
            thisClass.state.selectLinkageOption[index]
          ));
          // 不是筛选模式
        } else {
          ...
          selectTpl.push(_react2.default.createElement(
            _antd.Select,
            { key: index, value: thisClass.state.selectLinkageValue[index], onSelect: thisClass.handleLinkageSelect, placeholder: thisClass.props.placeholder[index] },
            thisClass.state.selectLinkageOption[index]
          ));
        }
      }
  ...
  this.updateOneOption = function (value, options) {
    ...
    if (value !== undefined) {
      selectTpl.push(_react2.default.createElement(
        _antd.Select,
        { key: 1, value: value + "", onChange: _this3.handleChange, placeholder: _this3.props.placeholder },
      ...
      if (_this3.props.isFilter) {
        selectTpl.push(_react2.default.createElement(
          _antd.Select,
          { key: 1, value: "", onChange: _this3.handleChange, placeholder: _this3.props.placeholder },
          _this3.state.options
        ));
        // 不是筛选模式
      } else {
        ...
        selectTpl.push(_react2.default.createElement(
          _antd.Select,
          { key: 1, value: _this3.props.value ? _this3.state.value + "" : undefined, onChange: _this3.handleChange, placeholder: _this3.props.placeholder },
