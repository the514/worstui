...
var ImgUpload = function (_Component) {
  ...
  function ImgUpload(props) {
    ...
    _this.handleRemove = function (file) {
      ...
      var thisClass = _this;
      console.log(_this.props.url + _Config2.default.uploadImgUrl() + "/" + file.uid);
      _axios2.default.delete(_this.props.url + _Config2.default.uploadImgUrl() + "/" + file.uid, config).then(function (response) {
