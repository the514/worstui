...
// 字段样式
var GetColumnConfig = function GetColumnConfig(k, v, object, thisClass, isHiddenDeleteButton) {
    ...
    case "_action":
      ...
      thisObject.render = function (text, record) {
        return _react2.default.createElement(
          ...
          showDeleteButton && _react2.default.createElement('span', { className: 'ant-divider' }),
