...
// 字段配置
function getColumns(columnObjArr, model) {
  var objArr = [];
  var obj = {};
  columnsWidth[model] = 0;
  _jquery2.default.each(columnObjArr, function (index, val) {
    obj = {};

    _jquery2.default.each(columnObjArr[index], function (k, v) {
