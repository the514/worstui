...
var Login = function (_Component) {
  ...
  function Login(props) {
    ...
    _this.onSubmit = function (e) {
      var loginColumnObj = {};
      var loginUserNameColumn = _Config2.default.loginUserNameColumn();
      var loginUserPasswordColumn = _Config2.default.loginUserPasswordColumn();

      loginColumnObj[loginUserNameColumn] = _this.state.mobile;
      loginColumnObj[loginUserPasswordColumn] = _this.state.password;
  ...
  _createClass(Login, [{
    ...
    value: function componentDidMount() {
      document.querySelector("title").innerHTML = _Config2.default.projectCn().title;
